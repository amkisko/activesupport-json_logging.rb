...
RSpec.describe JsonLogging::Formatter do
  ...
  it "serializes simple string messages" do
  ...
  it "serializes hashes as-is (without message wrapper)" do
  ...
  it "handles JSON string messages" do
  ...
  it "never raises on unprintable objects" do
    obj = Object.new
    def obj.to_s
      raise "nope"
    end

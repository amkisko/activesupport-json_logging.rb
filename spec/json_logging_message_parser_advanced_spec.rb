...
RSpec.describe JsonLogging::MessageParser do
  it "handles exceptions directly" do
    ex = begin
  ...
  it "handles exceptions with nil backtrace" do
  ...
  it "sanitizes parsed JSON strings" do
  ...
  it "handles non-hash objects with to_hash" do

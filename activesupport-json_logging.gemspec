...
Gem::Specification.new do |spec|
  ...
  spec.description = "Lightweight JSON logger and formatter integrating with Rails/ActiveSupport. No extra deps beyond Rails/Activesupport. Compatible with Rails 7–8."
